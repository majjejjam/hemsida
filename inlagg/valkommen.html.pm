#lang pollen
◊(define-meta date "17/3--23")

◊h1{Välkommen}

Hej, läsare kär. Varmt välkommen. Jag heter Miró -- det är min hemsida du hittat till. Den har skapats för att jag ska ha en plats att dela mina tankar och verk, och för att du ska ha en plats att konsumera dem. Det finns två anledningar att komma hit: innehåll och godhet.
...
◊h3{Tillgänglighet}
Jag gör mitt bästa för att ◊link["https://www.a11yproject.com/checklist/"]{följa riktlinjer} så att hemsidan ska vara tillgänglig för så många som möjligt. Det inkluderar bland annat hög typografisk standard, färgval som beaktar färgblindhet och att hemsidan ska vara navigerbar med tangentbord och talsyntes (◊abbr{TTS}).

◊center{***}

Oavsett om du väljer att komma åter -- det finns goda själ att avstå -- är jag glad att du läst mitt allra första inlägg. Jag önskar dig väl.
