...
◊ul{
◊li{◊link["https://vollkorn-typeface.com/"]{Vollkorn av ◊abbr{Friedrich Althausen}}}
◊li{◊link["https://www.huertatipografica.com/en/fonts/alegreya-sans-ht"]{◊span[#:style "font-family: AlegreyaSans; font-size: 105%;"]{Alegreya Sans} av ◊abbr{Juan Pablo del Peral}}}
◊li{◊link["https://fontlibrary.org/en/font/fantasque-sans-mono"]{◊span[#:style "font-family: Fantasque; opacity: 0.9"]{Fantasque} av ◊abbr{Jany Belluz}}}
◊li{◊link["https://github.com/zeynepakay/Rakkas"]{◊span[#:style "font-family: Rakkas; opacity: 0.8;"]{Rakkas} av ◊abbr{Zeynep Akay}}}
}
}
